    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-black text-white py-20 px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg">
          We are a passionate team dedicated to building solutions that empower
          businesses and people to achieve more.
        </p>
      </section>
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
        <div className="bg-white p-8 rounded-xl shadow hover:shadow-lg transition">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            technology solutions that help businesses grow faster and individuals
        ...
        <div className="bg-white p-8 rounded-xl shadow hover:shadow-lg transition">
          ...
          <p className="text-gray-600 leading-relaxed">
            We envision a world where technology simplifies everyday challenges,
            empowers people, and drives sustainable progress for communities
            worldwide.
          </p>
        </div>
      </section>
